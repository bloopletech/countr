-- MySQL dump 10.11
--
-- Host: localhost    Database: countr
-- ------------------------------------------------------
...
--
-- Table structure for table `counter_hits`
--
...
--
-- Dumping data for table `counter_hits`
--
...
CREATE TABLE `counters` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=451796 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2009-11-16  2:04:33
